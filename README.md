...
```bash
git clone https://github.com/BoatwrightLevel/Gamma-World-482.git
cd Gamma-World-482
python setup.py
```
...
https://github.com/BoatwrightLevel/Gamma-World-482/11a81855-5b51-4117-bfcd-ef07246e0a4e
...
<!-- Last updated: 2026-06-06 16:24:41 -->
